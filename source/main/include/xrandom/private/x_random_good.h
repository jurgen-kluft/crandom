...
namespace xcore
{
	...
	**/
	...
	public:
		...
		virtual u32			rand(s32 inBits = 32)									{ u32 r1 = (u8)(mIndex+4*53); u32 r2 = (u8)(mIndex+4); u32 r  = *((u32*)(mArray+r1)); *((u32*)(mArray+r2)) ^= r; mIndex = r2; return (r >> (32-inBits)); }
		virtual s32			randSign(s32 inBits = 31)								{ return (rand(inBits+1)-(1 << inBits)); }	
